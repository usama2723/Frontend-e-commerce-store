...
const SignUp = () => {
    ...
    function SignUpFunc(e) {
        ...
        axios.post('http://localhost:3000/api/user/signup', Obj).then(() => {
    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 h-screen w-full">
            ...
            <div className="bg-gray-800 flex flex-col justify-center">
                <form onSubmit={SignUpFunc} className="max-w-[400px] w-full mx-auto bg-gray-900 p-8 px-8 rounded-lg">
                    ...
                    <div className="flex flex-col text-gray-400 py-2">
                        ...
                        <input id="FullName" type="text" value={fullname} onChange={(e) => fullnameHandler(e)} required className="rounded-lg bg-gray-700 mt-2 p-2 focus:border-blue-500 focus:bg-gray-800 focus:outline-none" />
                    </div>
                    <div className="flex flex-col text-gray-400 py-2">
                    ...
                    <div className="flex justify-between text-gray-400 py-2">
                        <p className="flex items-center"><input className="mr-2" type="checkbox" />Accept Terms & Conditions </p>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-center">Already a member? <Link to={"/signin"} className="font-medium text-blue-600 underline dark:text-blue-500 hover:no-underline">Sign In</Link> </p>
